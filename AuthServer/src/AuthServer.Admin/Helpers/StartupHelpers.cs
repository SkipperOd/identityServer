...
using AuthServer.Admin.ExceptionHandling;
using AuthServer.Admin.Middlewares;
using AuthServer.Admin.Configuration;
using AuthServer.Admin.Configuration.ApplicationParts;
using AuthServer.Admin.Configuration.Constants;
using AuthServer.Admin.Configuration.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using AuthServer.Admin.Helpers.Localization;
